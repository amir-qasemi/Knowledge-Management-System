...
<div class="alert alert-block alert-danger alert-dismissable" id="actionErrorContainer"
	role="alert">
...
<div class="alert alert-block alert-success alert-dismissable"
	...
	<br />
	<form action="quiteSignup" method="post">
		<div style="visibility: hidden;">
			<input type="text" id="ActionUserName" name="userName">
		</div>
